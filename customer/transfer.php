...
$transferObject = new App\Classes\Customer\Transfer();



if (isset($_POST['transfer'])) {
  $transferObject->insertTransfer($_POST);
}
                ...
                <div class="mt-4 text-sm text-gray-500">
                  <form
                    ...
                    <input
                      ...
                      name="transfer_email"
                      id="transfer_email"
                      class="block w-full ring-0 outline-none mt-4 py-2 text-gray-800 border-b placeholder:text-gray-400 md:text-4xl"
