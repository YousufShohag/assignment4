...
<?php
  ...
  $getUserObjects = new App\Auth\Users();

  // $id = $_GET['costomerId'];
  // print_r($id);
  

  // if (isset($_GET['costomerId'])) {
  //   //$id = $_GET['costomerId'];
  //   // var_dump($id);
  //   $getUserObject = $getUserObjects->showUserInformation();
  
  // }
  // $getUserObject = $getUserObjects->showUserInformation();
  
  //   print_r($getUserObject);

  $transectionsObject = new App\Classes\Customer\Transfer();
  $id = $_GET['costomerId'];

  if (isset($_GET['costomerId'])) {
    $transections = $transectionsObject->showCustomerTransfer($id);
  
  }
// echo "<pre>";
//   var_dump($transections);
//   echo "</pre>";
//echo $transections['transfer_name'];
